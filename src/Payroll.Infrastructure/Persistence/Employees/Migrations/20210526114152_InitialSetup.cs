        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrivateEmailAddress = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CorporateEmailAddress = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_IdDocuments_Employees_EmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IdDocuments_EmployeeId",
                table: "IdDocuments",
                column: "EmployeeId");
        }
